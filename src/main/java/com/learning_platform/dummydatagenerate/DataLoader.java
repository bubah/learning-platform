...
public class DataLoader  implements CommandLineRunner {
    ...
    public DataLoader(CourseRepository courseRepository, LectureRepository lectureRepository, UserRepository userRepository) {
...
//                .setContent("Introduction to variables and expressions.")
//                .setOrder(0).build();
//
...
//                .setContent("Explains how to solve equations by isolating variables.")
//                .setOrder(1).build();
//
...
//                .setContent("Covers the fundamental rules of order of operations.").setOrder(2).build();
//
//        // Logic Sections
...
//                .setContent("Introduction to propositional logic and truth tables.").setOrder(3).build();
//
...
//                .setContent("Explores predicate logic with quantifiers.").setOrder(4).build();
//
...
//                .setContent("Explains how logical proofs work.").setOrder(5).build();
//
...
//                .setContent("Introduction to differential equations and their applications.").setOrder(6).build();
//
...
//                .setContent("Explores first-order differential equations and solving methods.").setOrder(7).build();
//
...
//                .setContent("Covers higher-order differential equations and solution techniques.").setOrder(8).build();
//
